...
Error: aws_alb.app_load_balancer: "vpc_id": this field cannot be set
Error: aws_alb.app_load_balancer: only alphanumeric characters and hyphens allowed in "name": "app_load_balancer"
Error: aws_instance.load_generator: : invalid or unknown key: enable_monitoring
Error: aws_instance.load_generator: ami must be a single value, not a map
Error: aws_launch_configuration.launch_conf: image_id must be a single value, not a map
Error: aws_launch_configuration.launch-conf: : invalid or unknown key: tags
*/
